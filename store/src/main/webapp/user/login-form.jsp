...
<%--
	요청 URL
		http://localhost/store/user/login-form.jsp
		http://localhost/store/user/login-form.jsp?invalid
		http://localhost/store/user/login-form.jsp?disabled
	요청 URI
		/store/user/login-form.jsp
	쿼리스트링
		없음
		invalid
		disabled
...
%>
	...
	<form class="border bg-light p-3" method="post" action="login.jsp">
		<div class="mb-3">
			...
			<input class="form-control"  type="text" name="id" value="hong"/>
		</div>
		<div class="mb-3">
