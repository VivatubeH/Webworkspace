    ...
    <div class="center container">
        ...
        <div class="subContent">
            ...
            <table class="table">
				...
				%>
						<tr>
							<td colspan="5" class="text-center">제목정보가 존재하지 않습니다.</td>
						</tr>
                <%	
					} else {
                ...
                <tr>
                    ...
                    <td> 
                    	<div>
                    		<div>
			                    <a href="hit.jsp?no=<%= board.getNo() %>&page=<%= pageNo %>" class="article">
			                    	<%= board.getTitle() %>
			                    </a>
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination justify-content-center">
                    ...
                    <li class="page-item <%=pagination.isLast() ? "disabled" : "" %>">
	                    <a class="page-link" href="list.jsp?page=<%=pagination.getNext() %>" >다음</a>
	                </li>
                </ul>
            </nav>
	        <%
