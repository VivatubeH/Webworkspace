...
%>
							...
							<div class="card-body">
							  ...
							  <a href="/sell/detail.jsp?no=<%=board.getNo() %>" class="d-block mt-4 link-body-emphasis link-offset-2 link-underline-opacity-25 link-underline-opacity-75-hover">보러가기
